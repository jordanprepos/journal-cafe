...
`backend/` directory is gone; `scripts/` holds only the one-off migration. A
few code comments still reference it — see [Known stale references](#known-stale-references).
